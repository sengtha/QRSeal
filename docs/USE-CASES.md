...
lie, which is where every documented Cambodian case sits — passes through all of
them untouched, which is what [README §3](../README.md#3-what-kh-sqr-cannot-solve)
