...
closed. Whether it already dominates losses is unmeasured (see the last
section); the paper's cases sit there because they were chosen to show the
boundary, not because they are a census. That ordering is
