...
land titles, driving permits and civil status documents, and it has attracted
substantial international recognition \citep{cambodianess2026verifygov}. Any
proposal in this space has to say how it relates to that system, and the honest
answer is that the two are solving the same problem with opposite architectures.
...
The scale makes this concrete rather than hypothetical. Several hundred
thousand secondary-school diplomas have been issued through the platform since
2022 --- reporting puts the figure above four hundred thousand
\citep{cambodianess2026verifygov} --- so a commitment measured in decades has
been accumulated in three years, and it grows by a cohort annually. Whether
those documents are still verifiable in 2060 is not a question about
cryptography. It is a question about whether an organisation and a domain name
outlive the people named on the certificates, and it is being answered by
default rather than by design. Offline verification also
