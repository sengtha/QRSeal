...
below the harm, it can be placed above it, by emptying the set of legitimate
artefacts rather than authenticating the illegitimate ones. We give that
corollary concretely as a categorical national prohibition on URL-bearing
payment and official QR codes, paired with a public rule that requires no
judgement to apply. We report two respects in which our own deployment and container fail to
